  ...
  !function (t) {
    ...
    var t,
      ...
      function n(e) {
        if (ee(e) && !c && !I(e)[2] && (e.stopImmediatePropagation(), !b || S)) {
          ...
          var t = k.offset(),
              ...
              a = I(e)[1] - t.left,
              n = "mcsLinearOut";
          if (R.push(o), _D.push(a), A[2] = Math.abs(I(e)[0] - A[0]), A[3] = Math.abs(I(e)[1] - A[1]), y.overflowed[0]) var i = O[0].parent().height() - O[0].height(),
      ...
      function i(e) {
        ...
        var o = k.offset();
        f = I(e)[0] - o.top, h = I(e)[1] - o.left, R = [], _D = [];
      }
      ...
      function r(e) {
        if (ee(e) && !c && !I(e)[2]) {
          ...
          if (!(g - p > 30)) {
            ...
            var n = "mcsEaseOut",
                i = 2.5 > x,
                r = i ? [R[R.length - 2], _D[_D.length - 2]] : [0, 0];
      ...
      function t(t, a) {
        if (V(o), !A(o, t.target)) {
          ...
          if ("x" === i.axis || "x" === i.mouseWheel.axis) var d = "x",
              ...
              g = t.deltaX || t.deltaY || a;else var d = "y",
