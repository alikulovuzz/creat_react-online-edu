...
(function (w) {
  ...
  respond.update = function () {}; //define ajax obj
  ...
  respond.mediaQueriesSupported = w.matchMedia && w.matchMedia("only all") !== null && w.matchMedia("only all").matches; //if media queries are supported, exit here
  ...
  applyMedia = function applyMedia(fromResize) {
    ...
    appendedEls.length = 0; //inject active styles, grouped by media type
  ...
  respond.getEmValue = getEmValue; //adjust on resize
