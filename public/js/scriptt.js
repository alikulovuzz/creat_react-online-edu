...
(function ($) {
  ...
  if ($('.hidden-bar').length) {
    ...
    var hiddenBarCloser = $('.hidden-bar-closer');
    $('.hidden-bar-wrapper').mCustomScrollbar();
    $('.hidden-bar .side-menu ul li.dropdown').append('<div class="dropdown-btn"><span class="arrow_carrot-down"></span></div>'); // //Show Sidebar
    // hiddenBarOpener.on('click', function () {
    // 	hiddenBar.addClass('visible-sidebar');
    // });
    //Hide Sidebar
...
})(window.jQuery); // function featuredfunc(id) {
